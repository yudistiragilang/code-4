...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/modules/weathericons/css/weather-icons.min.css">
  <link rel="stylesheet" href="<?php echo base_url(); ?>/public/assets/modules/weathericons/css/weather-icons-wind.min.css">
...
<body>
        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo base_url(); ?>/public/assets/img/products/product-3-50.png" alt="product">
                  oPhone S9 Limited Edition
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo base_url(); ?>/public/assets/img/products/product-2-50.png" alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?php echo base_url(); ?>/public/assets/img/products/product-1-50.png" alt="product">
                  Headphone Blitz
                </a>
              </div>
              <div class="search-header">
  ...
  <!-- JS Libraies -->
  <script src="<?php echo base_url(); ?>/public/assets/modules/simpleweather/jquery.simpleWeather.min.js"></script>
  <script src="<?php echo base_url(); ?>/public/assets/modules/chart.js/dist/Chart.min.js"></script>
  <script src="<?php echo base_url(); ?>/public/assets/modules/jqvmap/dist/jquery.vmap.min.js"></script>
  <script src="<?php echo base_url(); ?>/public/assets/modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
  <script src="<?php echo base_url(); ?>/public/assets/modules/summernote/dist/summernote-bs4.js"></script>
  ...
  <script src="<?php echo base_url(); ?>/public/assets/js/page/index-0.js"></script>
</body>
</html>
